...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-display-container w3-wide" id="home">
    ...
    <div class="w3-display-left w3-padding-large">
      ...
      <h6><button class="w3-button w3-white w3-padding-large w3-large w3-opacity w3-hover-opacity-off" onclick="document.getElementById('subscribe').style.display='block'" >Order</button></h6>
    </div>
  </header>
  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="jumbotron.jpg" alt="Men in Hats" style="width:100%" class="w3-padding-16">
          ...
          <div id="demo2" style="display:none">
            <div class="w3-row">
              ...
              <div class="w3-col l2 m3">
                <img src="x1.png" style="width:90px;">
              </div>
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          ...
          <div id="demo3" style="display:none">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="jumbotron.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
    ...
    <div class="w3-col l4">
      ...
      <div class="w3-white w3-margin">
        <img src="jumbotron.jpg" alt="Jane" style="width:100%" class="w3-grayscale">
